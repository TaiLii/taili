      ...
      return (
        <div className="bg-neutral-900 flex flex-row font-rozanova">
          ...
          <div className="w-full">
            <header className='fixed bg-neutral-900 w-screen pb-2'>
            ...
            <div className="top-0 left-0 p-2 fixed flex flex-row">
            ...
            <section id="about" ref={about} className={"h-screen flex justify-center items-center transition duration-150 "+(inViewAbout ? "scale-100 " : 'scale-90')}>
            ...
            <a href="#Home" className={'flex items-center justify-center text-xl right-0 bottom-0 fixed mr-60 mb-20 transition duration-150 bg-neutral-600 rounded-full p-2 shadow-md hover:bg-neutral-700 active:bg-neutral-500 ' + (inViewHome ? "invisible" : "visible")}> 
